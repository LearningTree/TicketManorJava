...
.*Build*
image:http://img.shields.io/badge/license-BSD2-green.svg[link="http://github.com/LearningTree/TicketManorJava/LICENSE"]
image:https://img.shields.io/badge/maven-Standard Builds-pink.svg[http://github.com/LearningTree/TicketManorJava/pom.xml"]
